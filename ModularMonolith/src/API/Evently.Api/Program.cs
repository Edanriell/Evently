...
string mongoConnectionString = builder.Configuration.GetConnectionStringOrThrow("Mongo");
...
builder.Services.AddHealthChecks()
	...
	.AddMongoDb(
		sp => new MongoClient(mongoConnectionString).GetDatabase("evently"), // pick your DB name
		"mongodb",
